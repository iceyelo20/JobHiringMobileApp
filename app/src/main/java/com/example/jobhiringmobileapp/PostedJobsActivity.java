...
public class PostedJobsActivity extends AppCompatActivity {
    ...
    private PostedJobAdapter jobAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar = (Toolbar) findViewById(R.id.posted_jobs_page_toolbar);
        ...
        if (search != null) {
            ...
            searchJob.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    jobAdapter = new PostedJobAdapter(PostedJobsActivity.this, jobArrayList);
